...
public class DdyntableService {
    ...
    public List<Map<String, Object>> getEntityByPage(Map<String,Object> params){
        return ddyntableMapper.pageDdyntable(params);
    }
    ...
    public List<Map<String, Object>> getEntityByList(Map<String,Object> params){
        List<Map<String, Object>> list= ddyntableMapper.getDdyntable(params);
        if(CollectionUtils.isNotEmpty(list))
            return list;
        return null;
    }
     ...
     * 作者: 仝玉锐
     */
    public void addEntity(Ddyntable entity){
        ddyntableMapper.insertDdyntable(entity);
    }
     ...
     * 作者: 仝玉锐
     */
    public void updateEntity(Ddyntable entity){
        ddyntableMapper.updateDdyntable(entity);
    }
    ...
    public void deleteEntity(String id){
        ddyntableMapper.deleteDdyntable(id);
    }
    ...
    public void batchDelEntity(List<String> ids){
        ddyntableMapper.batchdeleteDdyntable(ids);
    }
    ...
    public Long countEntity(Map<String,Object> params){
        return ddyntableMapper.countDdyntable(params);
    }
    /**
     * 功能 : 得到单个实体。
     * @param params 参数MAP
     ...
     * @author scy
     */
    public Ddyntable queryEntity(String id) {
