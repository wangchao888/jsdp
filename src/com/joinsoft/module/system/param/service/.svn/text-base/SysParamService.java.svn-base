...
package com.joinsoft.module.system.param.service;
...
public class SysParamService {
    ...
    public List<Map<String, Object>> getEntityByPage(Map<String,Object> params){
        return sysParamMapper.pageSysParam(params);
    }
    ...
    public List<Map<String, Object>> getEntityByList(Map<String,Object> params){
        List<Map<String, Object>> list= sysParamMapper.getSysParam(params);
        if(CollectionUtils.isNotEmpty(list))
            return list;
        return null;
    }
    ...
    public void addEntity(SysParam entity){
        sysParamMapper.insertSysParam(entity);
    }
     ...
     * 作者: 仝玉锐
     */
    public void updateEntity(SysParam entity){
        sysParamMapper.updateSysParam(entity);
    }
    ...
    public void batchDelEntity(List<String> ids){
        sysParamMapper.batchdeleteSysParam(ids);
    }
    ...
    public Long countEntity(Map<String,Object> params){
        return sysParamMapper.countSysParam(params);
    }
}
