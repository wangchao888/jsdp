...
<div class="wrapper wrapper-content animated fadeInRight">
          ...
          <div class="ibox-content white-bg">
            <form role="form" id="dataForm" class="form-horizontal">
              ...
              <div class="col-xs-12 ">
                ...
                <div class="col-xs-12">
                  <input type="text" name="tableid" id="tableid"  class="form-control">
              ...
              <div class="col-xs-12 ">
                ...
                <div class="col-xs-12">
                  <input type="text" name="tablenamecn" id="tablenamecn"  class="form-control">
                </div>
                </div>
              </div>                        
              <div class="form-group">
              ...
              <div class="col-xs-12 ">
                ...
                <div class="col-xs-12">            
               		<input type="checkbox" class="js-switch" id="stat" checked/>
	                <input type="hidden" name="ismodify" id="ismodify" value="1"/> 
	            </div>   
	            </div>        
              </div>
            </form>
    ...
    function saveForm(){
		...
		$.ajax({
            url:"${ctx}/system/dyntable/add",//提交地址
