...
<div class="wrapper wrapper-content animated fadeInRight">
          ...
          <div class="ibox-content white-bg">
            <form role="form" id="dataForm" class="form-horizontal">
               ...
               <div class="col-xs-12 ">
	              ...
	              <div class="col-xs-12">
	                  <input id="zonecodeName" type="text" readonly  onclick="showZone();" class="form-control">
	                  <input name="pid" type="hidden" id="zonecode" />
			   ...
			   <div class="col-xs-12 ">
                   ...
                   <div class="col-xs-12">
                      <input type="text" name="zonecode" id="zonecode"  class="form-control">
                   </div>
                   </div>
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
               		<div class="col-xs-12 ">
                    <label class="col-xs-12 control-label">区域类型<span class="star">*</span></label>
                    <div class="col-xs-12">
		                   	<select class="form-control m-b " name="zonetype" id="zonetype">
		                    	<jsdp:dic dictno="92"></jsdp:dic>
		                    </select>
	                </div>
	                </div>
               </div>
    ...
    function saveForm(){
		...
		$.ajax({
            url:"${ctx}/system/zoneCode/save",//提交地址
