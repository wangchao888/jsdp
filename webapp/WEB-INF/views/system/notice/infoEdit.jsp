...
<body class="white-bg">
  <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <form role="form" id="dataForm" class="form-horizontal">
            	<div class="form-group">
            		<div class="col-xs-12 ">
                     ...
                     <div class="col-xs-12">
                     	<input type="text" name="ntctitle" id="ntctitle"  class="form-control" value="${dataMap.NTCTITLE }">
                 ...
                 <div class="col-xs-12 ">
                     ...
                     <div class="col-xs-12">
                     	<select class="form-control m-b " name="ntctype" id="ntctype" >
	                    	<jsdp:dic dictno="01" dictlabel="${dataMap.NTCTYPE}"></jsdp:dic>
	                    </select>
                	 </div>
                	 </div>
                 </div>
                 ...
                 <div class="col-xs-12 ">
                     ...
                     <div class="col-xs-12">
                     <textarea id="describe" name="describe"  class="form-control" >${dataMap.DESCRIBE }</textarea>
                	 </div>
                	 </div>
                 </div>
                 <div class="form-group">
                 <div class="col-xs-12 ">
                     ...
                     <div class="col-xs-12">
                        <input id="userids" name="userids" type="hidden" />
                     	<select class="form-control m-b " name="usertype" id="usertype" onchange="changecombox();">
	                    	<option value="00" <c:if test="${dataMap.USERTYPE == '00'}">selected="selected"</c:if>>所有用户</option>
	                    	<option value="01" <c:if test="${dataMap.USERTYPE == '01'}">selected="selected"</c:if>>主管用户</option>
	                    	<option value="02" <c:if test="${dataMap.USERTYPE == '02'}">selected="selected"</c:if>>企业用户</option>
	                    	<option value="03" <c:if test="${dataMap.USERTYPE == '03'}">selected="selected"</c:if>>银行用户</option>
	                    </select>
                	 </div>
                	 </div>
                 </div>
                    ...
                    <c:choose>
						<c:when test="${dataMap.USERTYPE == '03'}">
						            ...
						            <tbody> 
						               ...
						               <tr>
						                  ...
						                  <td>
											 ...
											 <c:forEach items="${comList}" var="obj2" varStatus="status">
											 	<option value="${obj2.USERID }">${obj2.USERNAME }</option>
								             </c:forEach>
										  	 </select>	 
						                  </td>                                 
						               </tr>                                
						               ...
						               <tr>
						                  ...
						                  <td>
						                  	 <select ondblclick="role_s()" id='roles' multiple="multiple" style="width:220px;height:240px;border: 1px solid #ccc">
						                  	 	<c:forEach items="${comList}" var="obj2" varStatus="status"> 
	 						                   	  <option value="${obj2.CORPTYPE }">${obj2.DICTVALUE }</option> 
	 								            </c:forEach> 
										  	 </select>	 
						                  </td>                                 
						               </tr>                                
    ...
    function saveForm(){
		...
		$.ajax({
            url:"${ctx}/system/notice/updateInfo",//提交地址
